<?php class Testimonial_model extends CI_Model
{
	...
	{
		$sql =  $this->db->query("UPDATE `testimonial_db` SET `name`='".$updateData['name']."', `class`='".$updateData['class']."', `board`='".$updateData['board']."', `message`='".$updateData['message']."', `review_img_title`='".$updateData['review_img_title']."' WHERE id = '".$updateData['id']."' ");
	}
