											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div class="form-group">
														<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">Student Name*</label>
														<div class="col-xs-12 col-sm-6">
															<input type="text" id="name" name="name" required class="form-control" placeholder="Student Name" />
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="class">Class</label>
														<div class="col-xs-12 col-sm-6">
													...
													<div class="form-group">
														<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="board">College</label>
														<div class="col-xs-12 col-sm-6">
															<input type="text" id="board" name="board" class="form-control" placeholder="College Name" />
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
													...
													<div class="space-2"></div>
													<div class="form-group">
														<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="img_alt">Review Image Title</label>
														<div class="col-xs-12 col-sm-6">
															<input type="text" id="rev_alt" name="rev_alt" value="" class="form-control" placeholder="Image Title for Review Image" />
														</div>
													</div>
													<div class="space-2"></div>
													<div class="form-group">
														<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="message">Student Message</label>
														<div class="col-xs-12 col-sm-6">
