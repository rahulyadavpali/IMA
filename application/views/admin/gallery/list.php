		...
		<section class="content">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="breadcrumb">
					...
					<li class="active">Photo Gallery - Detail</li>
				</ul>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="box box-primary">
						<div class="box-header">
							<h1 class="box-title">Photo Gallery - Detail</h1>
							...
							<table id="sample-table-2" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td><div class="pnl_img"><img src="<?php echo base_url('library/uploads/gallery/'.$allresult[$key]['image']); ?>"></div></td>
										<td>
	...
	<script type="text/javascript">
		function TempDel(id){
			bootbox.confirm("<h3>Are you sure, You want to delete this entry?</h3>", function(result){
				if(result){
					$.ajax({
						url : "<?php echo base_url()."admin/photo/delete"?>",
						type : "POST",
						data : {"value" : id},
