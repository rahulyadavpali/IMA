    ...
    <section class="result_list_section pt-70 pb-50">
        <div class="container">
            <div class="row">
                <div class="masonry bordered clearfix">
                    <?php if(!empty($allresult)){$sno = 1;
                        foreach($allresult as $key => $val){ 
                    ?>
                    <div class="brick">
                        <a class="pop_catering matchHeight wow zoomIn" href="<?php echo base_url('library/uploads/gallery/'.$allresult[$key]['image']); ?>" class="gall_img" data-fancybox="group" data-caption="<?php echo $allresult[$key]['title']; ?>">
                            <img src="<?php echo base_url('library/uploads/gallery/'.$allresult[$key]['image']); ?>" alt="" title="<?php echo $allresult[$key]['title']; ?>" />
                        </a>
                    </div>
                    <?php 
                                $sno++;
        ...
        <div class="container pt-90 pb-65">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 talk_form">
                    <form id="talkExpertRes" name="talkExpertRes" action="<?php echo base_url('Gallery/addExpertRas/'); ?>" method="POST" class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                            <div class="tlk_frm_inpt">
                                <select id="tstrem" name="tstrem" placeholder="Strem" onchange="showRent(this)">
                                    ...
                                    <option value="Preallresults">Pre-allresults</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
